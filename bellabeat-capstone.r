...
# %% [code] {"_execution_state":"idle","execution":{"iopub.status.busy":"2023-05-03T11:22:51.135748Z","iopub.execute_input":"2023-05-03T11:22:51.137419Z","iopub.status.idle":"2023-05-03T11:22:52.909223Z"}}
library(tidyverse)
library(ggplot2)
